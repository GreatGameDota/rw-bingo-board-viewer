        ...
        return (
            ...
            <AnimatedBackground>
                ...
                <div className="flex-grow p-6 flex flex-col items-center">
                    <div style={{ fontFamily: 'RainWorldRodondo', fontSize: '154px' }} className="bg-gradient-to-r from-gray-500 via-gray-50 to-gray-500 bg-clip-text text-transparent animate-gradient [animation-duration:10s] bg-[length:300%_300%] cursor-default text-center tracking-[2rem]">
                        Rain world
                    </div>
                    <img
                    ...
                    <div className="w-full max-w-5xl bg-gray-800 border border-gray-700 rounded-lg p-6 mb-6 shadow-lg">
